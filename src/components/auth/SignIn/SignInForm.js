...
import EmailImage from '../../../assets/images/clarity_email-solid.png'
import PasswordImage from '../../../assets/images/bi_shield-lock-fill.png'
import EyeImage from '../../../assets/images/akar-icons_eye-open.png'
const SignInForm = () => {
      ...
      {({ errors, touched, values }) => (
        <Form>
          ...
          <div className="field-wrapper">
            ...
            <img src={EmailImage} className="email_image_png" />
            <Field
          ...
          <div className="field-wrapper">
            ...
            <img src={PasswordImage} className="password_image_png" />
            <Field className="form__input" name="password" type="password" placeholder="Password" />
            <img src={EyeImage} className="password_show_image" />
